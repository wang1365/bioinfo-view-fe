export default {
    ...
    CustomReferenceGenomeDetail: '自建参考基因组详情',
    SearchCustomDatabase: '搜索自定义数据库名',
    CreateCustomReferenceGenome: '新建自建参考基因组',
    EditCustomReferenceGenome: '编辑自建参考基因组',
    DeleteCustomReferenceGenome: '删除自建参考基因组',
    ConfirmDeleteCustomReferenceGenome: '确定要删除此自建参考基因组吗？',
    CustomDatabaseRequired: '自定义数据库名不能为空',
    HostRequired: '宿主不能为空',
    HostGenomeVersionRequired: '宿主基因组版本不能为空',
    VirusNameJsonFormat: '病毒种名JSON格式不正确',
    VirusTypeJsonFormat: '病毒分型JSON格式不正确',
    BasicInfo: '基本信息',
    FileInfo: '文件信息',
    SequenceInfo: '序列信息',
    HostSequenceInfo: '宿主原序列信息',
    VirusSequenceInfo: '病原原序列信息',
    BackToList: '返回列表',
    CloseRight: '关闭右侧',
    CloseLeft: '关闭左侧',
    CloseAll: '关闭所有',
    ...
    TaskPageListTableColumnOperate: '操作',
    TaskPageListTableRowBtnDeleteTmpTip: '仅会删除任务产生的中间文件,释放空间,不会影响任务结果展示.',
    TaskPageListTableRowBtnDeleteTmpTitle: '确认删除任务的中间文件吗?',
    TaskPageListTableRowBtnDeleteTmpComment: '仅会删除任务产生的中间文件,释放空间,不会影响任务结果展示.',
    ...
    DataListTableColumnTagLabel: 'Tag标签',
    ...
    Rp2SummaryTitleSuffix: '结果汇总',
    Rp2SampleList: '样本列表',
    Rp2BasicQcTab: '基础质控',
    Rp2NcQcTab: 'NC质控',
    Rp2ContaminationQcTab: '阳参和污染质控',
    Rp2Contamination: '污染评估',
    Rp2ViewResult: '查看结果',
    Rp2ConfigReport: '配置报告',
    Rp2DownloadReport: '下载报告',
    Rp2DownloadDefaultReport: '下载默认报告',
    Rp2DownloadCustomReport: '下载自定义报告',
    Rp2DefaultReportUnavailable: '默认报告不存在',
    Rp2CustomReportUnavailable: '自定义报告不存在',
    Rp2SampleName: '样本名',
    Rp2PatientInfo: '患者信息',
    ...
    Rp2BatchStats: '批次病原统计',
    Rp2PositiveStatsTab: '阳性样本检出统计',
    Rp2PathogenSummaryTab: '菌种检出统计',
    Rp2PathogenTypeTab: '病原类型检出统计',
    Rp2NcOverlapTab: '背景菌关联统计',
    Rp2SimilarityTab: '样本间相似性统计',
    Rp2TableOne: '表格1',
    Rp2TableTwo: '表格2',
    Rp2BarChart: '柱状图',
    Rp2PieChart: '饼图',
    Rp2Heatmap: '热力图',
    Rp2ImageNotFound: '图片不存在',
    Rp2ImagePreview: '图片预览',
    Rp2ZoomIn: '放大',
    Rp2ZoomOut: '缩小',
    Rp2ZoomReset: '重置',
    ...
    Rp2PositiveSampleCount: '阳性样本数',
    Rp2SamplePosNegStatTitle: '样本阴阳性统计',
    Rp2SamplePosNegDistTitle: '样本阴阳性分布',
    Rp2PositiveLabel: '阳性',
    Rp2NegativeLabel: '阴性',
    Rp2PathogenDetectDistPieTitle: '病原检测次数分布',
    Rp2PathogenDetectDistBarTitle: '病原检测次数分布',
    Rp2DetectCount: '检测次数',
    Rp2PathogenTypeDistTitle: '各类型病原数量分布',
    Rp2PathogenCount: '病原数量',
    Rp2SimilarityHeatmapTitle: '病原组成相似性热图',
    Rp2SimilarityScore: '相似度',
    Rp2SampleAxis: '样本',
    Rp2BasicQcTableTitle: '基础质控',
    Rp2NcResultTableTitle: 'NC检测结果',
    Rp2NcMarkTableTitle: '标黄NC污染的病原检测样本信息',
    Rp2TagContaminationTableTitle: '防污染tag列表',
    Rp2InternalControlTableTitle: '假病毒检测列表',
    Rp2GenusGroupTitle: '属',
    Rp2SpeciesGroupTitle: '种',
    Rp2CustomReportTitle: '{sample} 定制报告',
