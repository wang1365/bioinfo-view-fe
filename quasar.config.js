    ...
    return {
        ...
        devServer: {
            ...
            proxy: {
                '/api': {
                    changeOrigin: true,
                    target: process.env.host || 'http://10.10.0.208:8000',
                    // target: process.env.host || 'http://192.168.31.101:8000',
                    // target: process.env.host || "http://192.168.31.18:8000",
                    pathRewrite: {
                        '^/api': '', // base path替换
                    },
                },
